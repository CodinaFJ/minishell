...
/*   Updated: 2024/01/18 21:29:57 by jcodina-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_stack	*input_to_stack(char ***input, size_t size);
...
t_bool		assert_no_repeated(t_stack *norm_stack);
...
void		stack_execute_moves(t_stack *stack_a, t_stack *stack_b,
				char *str);
void		stack_execute_move_rep(t_stack *stack_a, t_stack *stack_b,
				char *str, size_t n);
void		stack_execute_move(t_stack *stack_a, t_stack *stack_b,
				char *str);
void		exec_moves_turk(t_stack *stack_a, t_stack *stack_b,
...
void		sort_3_normalized(t_stack *stack);
t_bool		stack_is_sorted(t_stack *stack_norm);

/*									SORT TURK								  */

void		sort_turk(t_stack *stack_a, t_stack *stack_b);
void		perform_min_moves(t_stack *stack_a, t_stack *stack_b,
				size_t index_a, size_t index_b);
size_t		select_best_candidate(const t_stack *stack_a,
				const t_stack *stack_b);
size_t		select_best_candidate_back(const t_stack *stack_a,
				const t_stack *stack_b);
